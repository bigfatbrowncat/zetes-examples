...
/**
 * CrossBaseCrossBaseGLCanvas is a widget capable of displaying OpenGL content.
 * 
 * @see GLData
...
/**
 * Create a CrossBaseGLCanvas widget using the attributes described in the GLData
 * object provided.
 *
 * @param parent a composite widget
 * @param style the bitwise OR'ing of widget styles
 * @param data the requested attributes of the CrossBaseGLCanvas
 *
...
/**
 * Sets the OpenGL context associated with this CrossBaseGLCanvas to be the
 * current GL context.
 * 
 * @exception SWTException <ul>
 *    <li>ERROR_WIDGET_DISPOSED - if the receiver has been disposed</li>
